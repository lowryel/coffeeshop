...
SECRET_KEY = 'django-insecure--=5yyc444(u6t&kqtbr_dgzdbv6)#o4*8gsd%&!nui2qw7^w3e'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

<<<<<<< Updated upstream
ALLOWED_HOSTS = ['172.0.0.1', 'koffeehook.herokuapp.com']
=======
ALLOWED_HOSTS = []
>>>>>>> Stashed changes
...
# static_files served by whitenoise
